function [Azloo,Azsig,Y,a,v,D] = single_trial_analysis(X, truth, duration, skipLOO, perm, eigratio, gamma, method)
...
%       a (forward model - scalp map of discriminating activity - dimensions [1 X Channels])
%       v (spatial filter used for discrimination)
%       D (# dimensions used for discrimination)
%
%
% Written by Marios G. Philiastides (last update: 1 July 2011)
